...
if("FALSE" STREQUAL "TRUE")
  set(rostest_SOURCE_PREFIX /home/adapt/rosalign/src/ros_comm/rostest)
  set(rostest_DEVEL_PREFIX /home/adapt/rosalign/devel_isolated/rostest)
  set(rostest_INSTALL_PREFIX "")
  set(rostest_PREFIX ${rostest_DEVEL_PREFIX})
else()
  set(rostest_SOURCE_PREFIX "")
  set(rostest_DEVEL_PREFIX "")
  set(rostest_INSTALL_PREFIX /home/adapt/rosalign/install_isolated)
...
if(NOT "include;/home/adapt/ADAPT/titan-sysroot/usr/include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rostest' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/adapt/rosalign/install_isolated/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(rostest_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/home/adapt/ADAPT/titan-sysroot/lib/libboost_system.a;/home/adapt/ADAPT/titan-sysroot/lib/libboost_thread.a")
