...
if("FALSE" STREQUAL "TRUE")
  set(rosconsole_SOURCE_PREFIX /home/adapt/rosalign/src/ros_comm/rosconsole)
  set(rosconsole_DEVEL_PREFIX /home/adapt/rosalign/devel_isolated/rosconsole)
  ...
  set(rosconsole_INSTALL_PREFIX /home/adapt/rosalign/install_isolated)
...
if(NOT "include;/home/adapt/ADAPT/titan-sysroot/usr/include" STREQUAL "")
  set(rosconsole_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/local/bluefin/adapt-sysroot/ros_install_isolated/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rosconsole' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/adapt/rosalign/install_isolated/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(rosconsole_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rosconsole;rosconsole_log4cxx;rosconsole_backend_interface;/home/adapt/ADAPT/titan-sysroot/lib/liblog4cxx.a;/home/adapt/ADAPT/titan-sysroot/lib/libboost_regex.a;/home/adapt/ADAPT/titan-sysroot/lib/libboost_system.a;/home/adapt/ADAPT/titan-sysroot/lib/libboost_thread.a")
