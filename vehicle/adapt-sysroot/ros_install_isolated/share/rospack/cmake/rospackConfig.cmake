...
if("FALSE" STREQUAL "TRUE")
  set(rospack_SOURCE_PREFIX /home/adapt/rosalign/src/rospack)
  set(rospack_DEVEL_PREFIX /home/adapt/rosalign/devel_isolated/rospack)
  set(rospack_INSTALL_PREFIX "")
  set(rospack_PREFIX ${rospack_DEVEL_PREFIX})
else()
  set(rospack_SOURCE_PREFIX "")
  set(rospack_DEVEL_PREFIX "")
  set(rospack_INSTALL_PREFIX /home/adapt/rosalign/install_isolated)
...
if(NOT "include;/home/adapt/ADAPT/titan-sysroot/usr/include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rospack' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/adapt/rosalign/install_isolated/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(rospack_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rospack;tinyxml;/usr/local/titan-sysroot/lib/libpython2.7.so;/home/adapt/ADAPT/titan-sysroot/lib/libboost_filesystem.a;/home/adapt/ADAPT/titan-sysroot/lib/libboost_program_options.a;/home/adapt/ADAPT/titan-sysroot/lib/libboost_system.a")
