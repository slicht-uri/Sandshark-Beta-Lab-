#include "MS89BSD.h"
MS89BSD::MS89BSD(const char* filename, int addr) :
    _open(true), _addr(addr), _filename(filename) {
}
...
bool MS89BSD::Read(float* pressure, float* temperature) {
