...
// Address is settable by pin configuration.  For now, comment out the incorrect addresses.
#define     SX1509_ADDRESS          0x3E    //  Chip address 1
// #define     SX1509_ADDRESS          0x3F    //  Chip address 2
// #define     SX1509_ADDRESS          0x70    //  Chip address 3
// #define     SX1509_ADDRESS          0x71    //  Chip address 4
...
class SX1509 {
  private:
    ...
    bool _write16(uint8_t, uint16_t*);
    bool _write8(uint8_t, uint8_t*);
    bool _read16(uint8_t, uint16_t*);
    bool _read8(uint8_t, uint8_t*);

    bool _reset(void);
  public:
    SX1509(const char* filename);
    ~SX1509();
    ...
    bool pwm(uint8_t, uint8_t);

    bool blink(uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t);
};
