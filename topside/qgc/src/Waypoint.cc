...
Waypoint::Waypoint(quint16 _id, double _x, double _y, double _z, double _param1, double _param2, double _param3, double _param4,
                   bool _autocontinue, bool _current, MAV_FRAME _frame, MAV_CMD _action, const QString& _description, int _da)
    : id(_id),
      x(_x),
      y(_y),
      z(_z),
...
void Waypoint::setParam8(int param8)
{
    if (this->da != param8) {
        this->da = param8;
        this->setParam7(this->z);
        emit changed(this);
    }
}
