...
QGCMissionNavWaypoint::QGCMissionNavWaypoint(WaypointEditableView* WEV) :
    ...
    ui(new Ui::QGCMissionNavWaypoint)
    {
        ...
        connect(this->ui->altDepthBox, SIGNAL(currentIndexChanged(int)),WEV,SLOT(changedParam8(int)));
        ...
        connect(WEV,SIGNAL(param8Broadcast(int)),this->ui->altDepthBox,SLOT(setCurrentIndex(int)));
    }
