...
PrimaryFlightDisplay::PrimaryFlightDisplay(QWidget *parent) :
    ...
    greenColor(QColor::fromHsvF(0.6, 1, 1)),

    lineWidth(2),
    fineLineWidth(1),

    instrumentEdgePen(QColor::fromHsvF(0, 0, 0.65, 0.5)),
    instrumentBackground(QColor::fromHsvF(0.6, 1, 1, 0.3)),
    instrumentOpagueBackground(QColor::fromHsvF(0.6, 1, 1, 1.0)),
...
void PrimaryFlightDisplay::drawAIGlobalFeatures(
    ...
    skyGradient.setColorAt(1, QColor::fromHsvF(0.6, 1.0, 0.7));
    skyGradient.setColorAt(0, QColor::fromHsvF(0.6, 0.25, 0.9));
    ...
    groundGradient.setColorAt(1, QColor::fromHsvF(0.6, 1.0, 0.7));
    groundGradient.setColorAt(0, QColor::fromHsvF(0.6, 0.5, 0.1));
